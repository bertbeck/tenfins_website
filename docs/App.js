        ...
        <div className="flyout">
          ...
          <div id="tech" className="technology padding-style-page">
            <div className="container text-center">
              <h3>Technology</h3> 
              <h2>
                Mobile apps today can be developed with Native, Hybrid or Cross Platforms tools. 
                ...
                React Native and Google's new tool Flutter are Cross Platform tools.
              </h2>
              <div className="row">
                <div className="col-md-4">
                  <div className="row">
                    <div className="col-md-12">
                      <h4>
                        Google Flutter is new tech that is coming on strong and will challenge React Native.
                      ...
                      <p className="author-style">
                        - Tim Sneath, 17-Year Microsoft Vet now leading Google's Flutter Team
                      </p>
                    </div>
                  </div>
                </div>
